          ...
          <section>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-sm border border-slate-100 dark:border-slate-700/50">
              <div className="w-full flex items-center p-4">
                ...
                <span className="text-xs bg-primary/10 dark:bg-primary/20 text-primary px-2 py-0.5 rounded-full font-medium">v1.0.33</span>
              </div>
            </div>
          </section>
        </div>
        <p className="text-center text-slate-400 text-[10px] mt-12 mb-12">离线听书 v1.0.33</p>
      </main>
    </div>
  );
};
